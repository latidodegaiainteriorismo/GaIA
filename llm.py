...
def call_groq(history: list, cross_memory: str = '') -> str:
    """
    ...
    Args:
        ...
        cross_memory: Contexto adicional de conversaciones anteriores (FASE 0)
                      En FASE 1 será sustituido por context.py
    ...
    logger.info(f'[LLM] Llamando Groq | msgs={len(messages)} | model={GROQ_MODEL}')
