...
def call_groq(history: list, cross_memory: str = '', knowledge_context: str = '',
    ...
    Args:
        ...
        astrology_context: Carta natal + tránsitos activos del usuario, ya
                            formateados por astrology.py — puede venir vacío ('')
                            si el usuario no tiene carta natal guardada
    Returns:
